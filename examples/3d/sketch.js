...
origami.reset = function(){
	...
	switch (selection)
	{
		...
		case 'T2':
			...
			break;
		case 'T3':
			this.cp.rotationalSymmetry(4);
			this.cp.crease(0, 0.2, 0.2, 0.2).valley();
			this.cp.crease(0.2, 0.2, 0.3, 0.2).mountain(90);
			this.cp.crease(0.3, 0.2, 0.4, 0.2).valley(90);
			this.cp.crease(0.4, 0.2, 0.6, 0.2).valley(45);
			this.cp.crease(0, 0.4, 0.2, 0.4).valley(45);
			this.cp.crease(0.2, 0.4, 0.4, 0.4).valley(90);
			this.cp.crease(0.4, 0.4, 0.6, 0.4).valley(45);
			this.cp.crease(0.2, 0, 0.2, 0.2).valley();
			this.cp.crease(0.2, 0.2, 0.2, 0.4).valley(90);
			this.cp.crease(0.3, 0, 0.3, 0.3).mountain();
			this.cp.crease(0.4, 0, 0.4, 0.2).valley(45);
			this.cp.crease(0.4, 0.2, 0.4, 0.4).valley(90);
			this.cp.crease(0, 0, 0.2, 0.2).mountain();
			this.cp.crease(0.2, 0.2, 0.3, 0.3).valley();
			this.cp.crease(0.3, 0.3, 0.4, 0.4).mountain(90);
			this.cp.crease(0.2, 0.4, 0.4, 0.2).mountain(90);
			break;
		case "T4":
